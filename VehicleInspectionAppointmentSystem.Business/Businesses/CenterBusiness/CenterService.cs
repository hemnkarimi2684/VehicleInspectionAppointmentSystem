...
namespace VehicleInspectionAppointmentSystem.Business.Businesses.CenterBusiness;
...
public class CenterService : ICenterService
{
    ...
    {
        var availableCityCenters = await _centerRepository.GetActiveCentersOfCityAsync(c => new CenterResponseDto
        (
            c.Id,
            c.CenterCode,
            c.Name,
