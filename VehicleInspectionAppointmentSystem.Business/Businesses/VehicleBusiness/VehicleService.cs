...
namespace VehicleInspectionAppointmentSystem.Business.Businesses.VehicleBusiness;
...
public class VehicleService : IVehicleService
{
    ...
    {
        var vehicles = await _vehicleRepository.GetUserVehiclesAsync(v => new VehicleResponseDto 
        (
            v.Id,
            v.Name,
            v.Vin,
